...
cp dist/mcp-nomad-go_darwin_amd64_v1/mcp-nomad ./packages/npm-mcp-nomad-darwin-x64/bin/mcp-nomad
chmod +x ./packages/npm-mcp-nomad-darwin-x64/bin/mcp-nomad
mkdir -p ./packages/npm-mcp-nomad-darwin-arm64/bin
cp dist/mcp-nomad-go_darwin_arm64_v8.0/mcp-nomad ./packages/npm-mcp-nomad-darwin-arm64/bin/mcp-nomad
chmod +x ./packages/npm-mcp-nomad-darwin-arm64/bin/mcp-nomad

# Linux
mkdir -p ./packages/npm-mcp-nomad-linux-x64/bin
cp dist/mcp-nomad-go_linux_amd64_v1/mcp-nomad ./packages/npm-mcp-nomad-linux-x64/bin/mcp-nomad
chmod +x ./packages/npm-mcp-nomad-linux-x64/bin/mcp-nomad
mkdir -p ./packages/npm-mcp-nomad-linux-arm64/bin
cp dist/mcp-nomad-go_linux_arm64_v8.0/mcp-nomad ./packages/npm-mcp-nomad-linux-arm64/bin/mcp-nomad
chmod +x ./packages/npm-mcp-nomad-linux-arm64/bin/mcp-nomad

# Windows
mkdir -p ./packages/npm-mcp-nomad-win32-x64/bin
cp dist/mcp-nomad-go_windows_amd64_v1/mcp-nomad.exe ./packages/npm-mcp-nomad-win32-x64/bin/mcp-nomad.exe
mkdir -p ./packages/npm-mcp-nomad-win32-arm64/bin
cp dist/mcp-nomad-go_windows_arm64_v8.0/mcp-nomad.exe ./packages/npm-mcp-nomad-win32-arm64/bin/mcp-nomad.exe
